...
def main():
    ...
    print('='*80)
    print(f'重新测试k=2全类别CLS任务 - 修复双重融合BUG后')
    ...
    output_csv = 'retest_all_cls_k2_results.csv'
    ...
    if n_success > 0:
        ...
        # 读取baseline
        df_bl_mvtec = pd.read_csv('result/baseline/mvtec/k_2/csv/Seed_111-results.csv')
        df_bl_visa = pd.read_csv('result/baseline/visa/k_2/csv/Seed_111-results.csv')
