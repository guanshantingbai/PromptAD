...
if __name__ == '__main__':
    ...
    datasets = ['mvtec', 'visa']
    shots = [2]  # k=2
    output_dir = './result/test_reduced_prompts'  # 使用减少 prompts 后的输出目录
    gpu_id = 0
    ...
    print(f"   - MVTec CSV: {output_dir}/mvtec/k_2/csv/Seed_111-results.csv")
    print(f"   - VisA CSV: {output_dir}/visa/k_2/csv/Seed_111-results.csv")
