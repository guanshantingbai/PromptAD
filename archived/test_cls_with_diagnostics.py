"""
Test script with integrated multi-prototype diagnostics.
...
def test_with_diagnostics(
    ...
    """Test with prototype diagnostics enabled."""
    ...
    if args.save_diagnostics:
        ...
        diag_file = diag_dir / f"{args.class_name}_k{args.k_shot}_diagnostics.json"
...
def get_args():
    parser = argparse.ArgumentParser(description='Anomaly detection with prototype diagnostics')
