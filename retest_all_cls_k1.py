...
def main():
    ...
    output_csv = 'retest_all_cls_k1_results.csv'
    ...
    if n_success > 0:
        ...
        # 读取baseline
        df_bl_mvtec = pd.read_csv('result/baseline/mvtec/k_1/csv/Seed_111-results.csv')
        df_bl_visa = pd.read_csv('result/baseline/visa/k_1/csv/Seed_111-results.csv')
